...
namespace PrismDemo.B.Models
{
    ...
    /// B 字段配置
    /// </summary>
    public class BFieldConfig : IFilterConfig
    {
    ...
    /// </summary>
    public class BData : Dictionary<string, ConnectData>
    {
        /// <summary>
        ...
        /// 获取需要保存到数据库的字段配置列表
        /// </summary>
        public IEnumerable<BFieldConfig> GetStoreFields(IEnumerable<BFieldConfig> configs)
